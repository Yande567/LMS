    ...
    <nav id="sidebarMenu" class="collapse d-lg-block sidebar">
      <div class="">
        <div class="list-group list-group-flush mx-3 mt-4">
          ...
          <a href="#" class="list-group-item list-group-item-action py-2 ripple"><i
            class="fas fa-chart-line fa-fw me-3"></i><span>Register Librarian</span></a>
          <a href="#" class="list-group-item list-group-item-action py-2 ripple"><i
            class="fas fa-chart-line fa-fw me-3"></i><span>Register Students</span></a>
          <a href="#" class="list-group-item list-group-item-action py-2 ripple">
            <i class="fas fa-chart-pie fa-fw me-3"></i><span>Registered Librarian</span>
          </a>
          <a href="#" class="list-group-item list-group-item-action py-2 ripple">
